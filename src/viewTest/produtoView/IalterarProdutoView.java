...
public interface IalterarProdutoView extends IlistarProdutosView, Iscanner {
		...
		try {
			...
			while (true) {
				...
				if (opcaoAlterar.equalsIgnoreCase("listar")) {
					...
					System.out.println(ProdutoRules.alterarRule(listaProdutos.get(0)));
